...
private:
    ...
    void createSwapChain() {
        ...
        * and any images associated with the prior entry become available for reuse by the application. 
        ...
        * New requests are appended to the end of the queue, and one request is removed from the beginning of the queue and processed during each vertical blanking period in which the queue is non-empty. This is the only value of presentMode that is required to be supported.
        * 
